...
const addToCart = (product) => {
  ...
  if (existingProductIndex !== -1) {
    ...
    cartItems[existingProductIndex].newPrice =
      cartItems[existingProductIndex].quantity * product.newPrice; // Update newPrice based on quantity
  } else {
...
const updateQuantity = (e) => {
  ...
  if (productIndex !== -1 && quantity > 0) {
    ...
    cartItems[productIndex].newPrice =
      cartItems[productIndex].quantity *
      computers.find((product) => product.id === cartItems[productIndex].id)
        .newPrice;
